const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do BaizeAI com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados que o aplicativo coleta, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do BaizeAI.',
        },
      },
      embedded: {
        entry: 'Embutido',
        ...
        chromePlugin: 'Instalar Extensão do Chatbot BaizeAI para o Chrome',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'BaizeAI-WebClient',
