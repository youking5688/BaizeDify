const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of BaizeAI with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see BaizeAI\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Embedded',
        ...
        chromePlugin: 'Install BaizeAI Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
