const translation = {
  ...
  welcome: 'Welcome to BaizeAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting BaizeAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on BaizeAI',
  invalid: 'The link has expired',
  explore: 'Explore BaizeAI',
