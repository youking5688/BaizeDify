const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Describe what is in this Knowledge. A detailed description allows AI to access the content of the Knowledge in a timely manner. If empty, BaizeAI will use the default hit strategy.',
