const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'BaizeAI account',
    langGeniusAccountTip: 'Your BaizeAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to BaizeAI to access your team data.',
  ...
  integrations: {
    ...
    wechat: 'WeChat',
    wechatAccount: 'Login with WeChat account',
    connect: 'Connect',
  },
  language: {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by BaizeAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across BaizeAI\'s applications.',
