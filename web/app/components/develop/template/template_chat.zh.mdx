...
<Row>
  ...
  <CodeGroup title="Request" tag="POST" label="/meta" targetCode={`curl -X GET '${props.appDetail.api_base_url}/meta?user=abc-123' \\\n-H 'Authorization: Bearer {api_key}'`}>
    ...
    {
      "tool_icons": {
          "dalle2": "https://baizeai.nextv.show/console/api/workspaces/current/tool-provider/builtin/dalle/icon",
          "api_tool": {
              "background": "#252525",
              "content": "\ud83d\ude01"
          }
