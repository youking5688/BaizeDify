  ...
  >
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col'>
          ...
          <a href={`https://baizeai.nextv.show/${isChatApp ? 'webapp-conversation' : 'webapp-text-generator'}`} target='_blank' rel='noopener noreferrer'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col w-full overflow-hidden'>
          ...
          <pre className='overflow-x-scroll box-border py-3 px-4 bg-gray-100 text-xs font-medium rounded-lg select-text'>
            ...
            NEXT_PUBLIC_APP_KEY={'\'<Web API Key From BaizeAI>\''} <br />
    ...
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <Button
        ...
        onClick={() =>
          window.open(
            `https://docs.baizeai.nextv.show/${locale !== LanguagesSupported[1]
              ? 'user-guide/baizeai-apps/developing-with-apis'
